...
/**
 * help_alias - shellby builtin command info 'alias'.
 */
...
/**
 * help_exit - shellby builtin command info 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_cd - shellby builtin command info 'cd'.
 */
void help_cd(void)
{
